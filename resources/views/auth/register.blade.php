    ...
    <section class="card">
      ...
      <aside class="card-visual">
        ...
        <div class="hero">
          ...
          <p>Accédez à tous nos cours et suivez vos progrès.</p>
          <ul class="bullets">
      ...
      <div class="card-form">
        ...
        <p class="subtext">Rejoignez-nous gratuitement !</p>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="password-wrap">
                <input class="input" 
                       ...
                       placeholder="••••••••" 
                       required>
                <button class="toggle-btn" type="button" onclick="togglePasswordConfirm()">👁</button>
            </div>
            ...
            <div class="form-check mt-2">
                ...
                <label class="form-check-label">
                    J'accepte les <a href="#">Conditions & Confidentialité</a>.
                </label>
            </div>
