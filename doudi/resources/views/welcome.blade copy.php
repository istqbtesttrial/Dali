...
<section class="fixed-top navigation">
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-light">
      <a class="navbar-brand" href="index.html"><img src="images/logo.png" alt="logo" height="150px" width="200px"></a>
    ...
    <div class="row">
      <div class="col-lg-12 text-center zindex-1">
        <h1 class="mb-3">Bienvenue<br>
            Smart Stage "Autoliv" </h1>
        <p class="mb-4">Votre espace<br>
            de gestion des stagiaires.</p>
