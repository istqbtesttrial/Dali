<!DOCTYPE html>
 <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ config('Smart municipality', 'Smart municipality') }}</title>
             ...
             <div class="page-main">
                 ...
                 <aside class="app-sidebar">
                     ...
                     <ul class="side-menu app-sidebar3">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="absences">
                            ...
                            <span class="side-menu__label">Absences</span></span></a>

                        </li>
                        
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="stagiaires">
                            ...
                            <span class="side-menu__label">Stagiaires</span></a>
