<!DOCTYPE html>
 <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ config('Smart stage', 'Smart stage') }}</title>
...
<aside class="app-sidebar">
    <div class="app-sidebar__logo">
        <a class="header-brand" href="index.html">
            ...
            <img src="{{asset('assets/images/brand/logo.png')}}" class="header-brand-img dark-logo" alt="Azea logo">
            <img src="{{asset('assets/images/brand/logo.png')}}" class="header-brand-img mobile-logo" alt="Azea logo">
        ...
        @if(Auth::check() && Auth::user()->id == 1)
            ...
            <li class="slide">
                <a class="side-menu__item" href="">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <path d="M8 0L0 4v8l8 4 8-4V4L8 0zM7 11H5V9h2v2zm0-4H5V5h2v2zm4 4H9V9h2v2zm0-4H9V5h2v2z"/>
                    </svg>
                    <span class="side-menu__label">Statistiques</span>
                </a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('etudiants') }}">
                    ...
                    <span class="side-menu__label">Etudiants</span>
                </a>
            </li>

            <li class="slide">
                <a class="side-menu__item" href="{{ url('formations') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
            ...
            <li class="slide">
                <a class="side-menu__item" href="">
                    ...
                    <span class="side-menu__label">Demandes Suggestions</span>
                </a>
            </li>

        @else
            {{-- Sidebar pour les autres utilisateurs --}}
            <li class="slide">
                <a class="side-menu__item" href="{{ url('formations') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M6.5 0A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3Z"/>
                                                     ...
                                                     <div class="dropdown profile-dropdown d-flex">
                                                         ...
                                                         <a href="{{asset('javascript:void(0);')}}" class="nav-link pe-0 leading-none" data-bs-toggle="dropdown">
                                                             <span class="header-avatar1">
                                                               <img src="{{asset('assets/images/users/admin.png')}}" alt="img" class="avatar avatar-md brround">
                                                             </span>
                                                         </a>
                                                         ...
                                                         <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                                             <div class="text-center">
                                                                 ...
                                                                 <span class="text-center user-semi-title">Administrateur  </span>
                     ...
                     <div class="container">
                         <div class="row align-items-center flex-row-reverse">
                             <div class="col-md-12 col-sm-12 text-center">
                                 Copyright © 2022 <a href="javascript:void(0);">Smart Stage</a> developpé  <span class="fa fa-heart text-danger"></span>par : <a href="javascript:void(0);"> Muhammed Said Boubaker </a> tout les droits reservés
                             </div>
                         </div>
                     </div>
                 </footer>
